...
namespace Chess
{
    public partial class ChessBoard
    {
        ...
        public Move[] RandomMoves(int number)
        {
            Random rand = new Random(DateTime.UtcNow.Millisecond);
            var moves = Moves().ToList();
            var rmoves = new List<Move>();
            for (int i = 0; i < number; i++)
            {
                var index = rand.Next() % moves.Count;
                rmoves.Add(moves[index]);
                moves.RemoveAt(index);
            }
            return rmoves.ToArray();
        ...
        internal static Position[] GeneratePositions(Position piecePosition, ChessBoard board, bool ignoreStop = false)
        {
            ...
            switch (board[piecePosition].Type)
            {
                case var e when e == PieceType.Pawn:
                    GeneratePawnPositions(piecePosition, board, positions, ignoreStop);
                    break;
                ...
                case var e when e == PieceType.Knight:
                    GenerateKnightPositions(piecePosition, board, positions, ignoreStop);
                    break;
        ...
        private static void GenerateKnightPositions(Position piecePosition, ChessBoard board, List<Position> positions, bool ignoreStop = false)
        {
        ...
        private static void GeneratePawnPositions(Position piecePosition, ChessBoard board, List<Position> positions, bool ignoreStop = false)
        {
        ...
        private static void GenerateBishopPositions(Position piecePosition, ChessBoard board, List<Position> positions, bool ignoreStop = false)
        {
        ...
        private static void GenerateRookPositions(Position piecePosition, ChessBoard board, List<Position> positions, bool ignoreStop = false)
        {
