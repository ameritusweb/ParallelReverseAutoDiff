// ------------------------------------------------------------------------------
// <copyright file="ClassifyComputationGraph.cs" author="ameritusweb" date="6/18/2023">
...
namespace ParallelReverseAutoDiff.Test.GraphAttentionLstm.LSTM
{
    ...
    /// </summary>
    public class ClassifyComputationGraph : ComputationGraph
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClassifyComputationGraph"/> class.
        /// </summary>
        /// <param name="net">The neural network.</param>
        public ClassifyComputationGraph(ClassifyNeuralNetwork net)
            : base(net)
        {
        }
