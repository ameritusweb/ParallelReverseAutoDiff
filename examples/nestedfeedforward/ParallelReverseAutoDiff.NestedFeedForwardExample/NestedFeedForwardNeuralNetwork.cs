//------------------------------------------------------------------------------
// <copyright file="NestedFeedForwardNeuralNetwork.cs" author="ameritusweb" date="5/5/2023">
...
namespace ParallelReverseAutoDiff.FeedForwardExample
{
    ...
    /// <summary>
    /// A nested feed forward neural network.
    /// </summary>
    public partial class NestedFeedForwardNeuralNetwork : NeuralNetwork
    {
        private const string NAMESPACE = "ParallelReverseAutoDiff.NestedFeedForwardExample.architecture";
        private const string ARCHITECTURE = "NestedFeedForwardArchitecture";
        private EmbeddingLayer embeddingLayer;
        private OutputLayer outputLayer;

        private NestedFeedForwardComputationGraph computationGraph;

        /// <summary>
        /// Initializes a new instance of the <see cref="NestedFeedForwardNeuralNetwork"/> class.
        /// </summary>
        ...
        public NestedFeedForwardNeuralNetwork(int inputSize, int hiddenSize, int outputSize, int numLayers, double learningRate, double? clipValue)
        {
        ...
        private async Task InitializeComputationGraph()
        {
            ...
            this.computationGraph = new NestedFeedForwardComputationGraph(this);
    ...
    /// </summary>
    public partial class NestedFeedForwardNeuralNetwork
    {
