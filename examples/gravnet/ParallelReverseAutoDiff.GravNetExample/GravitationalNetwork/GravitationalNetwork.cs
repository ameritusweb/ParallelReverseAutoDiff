namespace ParallelReverseAutoDiff.GravNetExample.GravitationalNetwork
{
    ...
    public class GravitationalNetwork : NeuralNetwork
    {
        private const string NAMESPACE = "ParallelReverseAutoDiff.GravNetExample.GravitationalNetwork.Architecture";
        private const string ARCHITECTURE = "gravnet";
        ...
        private GravitationalComputationGraph computationGraph;
        ...
        public GravitationalNetwork(int numLayers, int numNodes, int numFeatures, double learningRate, double clipValue)
        {
