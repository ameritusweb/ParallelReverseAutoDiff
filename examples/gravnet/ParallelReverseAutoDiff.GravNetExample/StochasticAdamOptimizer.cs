...
namespace ParallelReverseAutoDiff.GravNetExample
{
    public class StochasticAdamOptimizer
    {
        ...
        public void Reset()
        {
            ...
            //this.countValues = new Dictionary<string, (int, double)>();
        }
        ...
        private void UpdateWeightWithAdam(string identifier, Matrix w, Matrix mW, Matrix vW, Matrix gradient, double beta1, double beta2, double epsilon, ref Dictionary<double, (int, int)> positiveChanges, ref Dictionary<double, (int, int)> negativeChanges)
        {
