namespace ParallelReverseAutoDiff.GravNetExample.TiledNetwork
{
    ...
    public class TiledNetwork : NeuralNetwork
    {
        private const string NAMESPACE = "ParallelReverseAutoDiff.GravNetExample.TiledNetwork.Architecture";
        private readonly string ARCHITECTURE;

        private readonly IModelLayer inputLayer;

        private TiledComputationGraph computationGraph;
        ...
        public TiledNetwork(int numLayers, int numNodes, int numFeatures, double learningRate, double clipValue, string architecture)
        {
        ...
        public void InitializeState()
        {
            ...
            {
                this.Tiled.Replace(glyph.ToArray());
            }
            ...
            {
                this.RotationTargets.Replace(rotationTargets.ToArray());
            }
        ...
        private async Task InitializeComputationGraph()
        {
            ...
            this.computationGraph = new TiledComputationGraph(this);
            this.computationGraph
                .AddIntermediate("Output", _ => this.Output)
                .AddIntermediate("Input", _ => this.Input)
                .AddIntermediate("Tiled", _ => this.Tiled)
