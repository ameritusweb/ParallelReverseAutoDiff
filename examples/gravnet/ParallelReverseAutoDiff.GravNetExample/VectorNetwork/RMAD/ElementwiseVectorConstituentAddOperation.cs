//------------------------------------------------------------------------------
// <copyright file="ElementwiseVectorConstituentAddOperation.cs" author="ameritusweb" date="5/2/2023">
...
namespace ParallelReverseAutoDiff.RMAD
{
    ...
    /// </summary>
    public class ElementwiseVectorConstituentAddOperation : Operation
    {
        ...
        {
            return new ElementwiseVectorConstituentAddOperation();
        }
        ...
        /// <param name="weights1">The weights.</param>
        /// <param name="weights2">The weights 2.</param>
        /// <returns>The output of the Hadamard product operation.</returns>
        public Matrix Forward(Matrix input1, Matrix input2, Matrix weights1, Matrix weights2)
        {
            this.input1 = input1;
            this.input2 = input2;
