//------------------------------------------------------------------------------
// <copyright file="NewGpuMatrixMultiplyOperation.cs" author="ameritusweb" date="5/2/2023">
...
namespace ParallelReverseAutoDiff.RMAD
{
    ...
    /// </summary>
    public class NewGpuMatrixMultiplyOperation : Operation
    {
        ...
        {
            return new NewGpuMatrixMultiplyOperation();
        }
