...
{
    using ParallelReverseAutoDiff.VLstmExample.VLstmNetwork;
    using System;
    ...
    public class ElementwiseVectorCartesianSummationOperation : Operation
    {
        ...
        private VectorLstmNetwork vectorNetwork;

        public ElementwiseVectorCartesianSummationOperation(VectorLstmNetwork vectorNetwork)
        {
        ...
        {
            return new ElementwiseVectorCartesianSummationOperation(net as VectorLstmNetwork);
        }
