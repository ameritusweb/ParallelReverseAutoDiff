//------------------------------------------------------------------------------
// <copyright file="SquaredArclengthEuclideanMagnitudeLossOperation3.cs" author="ameritusweb" date="7/1/2023">
...
namespace ParallelReverseAutoDiff.VGruExample.VGruNetwork.RMAD
{
    ...
    /// </summary>
    public class SquaredArclengthEuclideanMagnitudeLossOperation3
    {
        ...
        public static SquaredArclengthEuclideanMagnitudeLossOperation3 Instantiate(NeuralNetwork net)
        {
            return new SquaredArclengthEuclideanMagnitudeLossOperation3();
        }
