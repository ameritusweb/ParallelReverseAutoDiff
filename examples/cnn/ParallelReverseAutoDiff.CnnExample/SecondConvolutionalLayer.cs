//------------------------------------------------------------------------------
// <copyright file="SecondConvolutionalLayer.cs" author="ameritusweb" date="5/18/2023">
...
namespace ParallelReverseAutoDiff.CnnExample
{
    ...
    public class SecondConvolutionalLayer
    {
        ...
        /// <param name="previousSecondLayer">The previous second layer.</param>
        ...
        {
            this.Cf2 = CommonMatrixUtils.InitializeRandomMatrixWithXavierInitialization(this.previousLayer != null ? (this.previousLayer.Cf1.Length + this.convolutionalNeuralNetwork.NumFilters) : ((this.previousSecondLayer?.Cf2.Length ?? throw new InvalidOperationException("The previous second layer cannot be null.")) + this.convolutionalNeuralNetwork.NumFilters), this.previousLayer != null ? this.previousLayer.Cf1.Length : (this.previousSecondLayer?.Cf2.Length ?? throw new InvalidOperationException("The previous second layer cannot be null.")), this.convolutionalNeuralNetwork.FilterDimensions.Height, this.convolutionalNeuralNetwork.FilterDimensions.Width);
            this.Cb2 = CommonMatrixUtils.InitializeZeroMatrix(this.Cf2.Length, 1);
            this.Sc2 = CommonMatrixUtils.InitializeRandomMatrixWithXavierInitialization(this.previousLayer != null ? (this.previousLayer.Sc1.Rows / this.convolutionalNeuralNetwork.Parameters.PoolSize) + 3 : (this.previousSecondLayer?.Sc2.Rows ?? throw new InvalidOperationException("The previous second layer cannot be null.")) + 3, this.Cf2.Length);
            this.Sh2 = CommonMatrixUtils.InitializeRandomMatrixWithXavierInitialization(this.previousLayer != null ? (this.previousLayer.Sh1.Rows / this.convolutionalNeuralNetwork.Parameters.PoolSize) + 3 : (this.previousSecondLayer?.Sh2.Rows ?? throw new InvalidOperationException("The previous second layer cannot be null.")) + 3, this.Cf2.Length);
