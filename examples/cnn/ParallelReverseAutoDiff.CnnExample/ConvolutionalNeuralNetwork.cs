//------------------------------------------------------------------------------
// <copyright file="ConvolutionalNeuralNetwork.cs" author="ameritusweb" date="5/18/2023">
...
namespace ParallelReverseAutoDiff.CnnExample
{
    ...
    using ParallelReverseAutoDiff.CnnExample.RMAD;
    ...
    {
        private const string NAMESPACE = "ParallelReverseAutoDiff.CnnExample.architecture";
        ...
        /// <param name="filterDimensions">The filter dimensions.</param>
