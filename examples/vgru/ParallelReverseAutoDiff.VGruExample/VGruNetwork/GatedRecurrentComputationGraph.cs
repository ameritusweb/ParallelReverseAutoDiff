// ------------------------------------------------------------------------------
// <copyright file="GatedRecurrentComputationGraph.cs" author="ameritusweb" date="12/18/2023">
...
namespace ParallelReverseAutoDiff.VGruExample.VGruNetwork
{
    ...
    /// </summary>
    public class GatedRecurrentComputationGraph : ComputationGraph
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GatedRecurrentComputationGraph"/> class.
        /// </summary>
        /// <param name="net">The neural network.</param>
        public GatedRecurrentComputationGraph(GatedRecurrentNetwork net)
            : base(net)
        {
        }
