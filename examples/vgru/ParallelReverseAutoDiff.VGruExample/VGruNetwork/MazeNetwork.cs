// ------------------------------------------------------------------------------
// <copyright file="MazeNetwork.cs" author="ameritusweb" date="12/18/2023">
...
namespace ParallelReverseAutoDiff.VGruExample.VGruNetwork
{
    ...
    public class MazeNetwork : NeuralNetwork
    {
        ...
        private MazeComputationGraph computationGraph;

        private Maze maze;

        /// <summary>
        /// Initializes a new instance of the <see cref="MazeNetwork"/> class.
        /// </summary>
        ...
        public MazeNetwork(int numTimeSteps, int numLayers, int numNodes, int numFeatures, double learningRate, double clipValue)
        {
