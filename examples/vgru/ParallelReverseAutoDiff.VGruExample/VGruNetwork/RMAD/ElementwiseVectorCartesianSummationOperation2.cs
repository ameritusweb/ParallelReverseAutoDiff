//------------------------------------------------------------------------------
// <copyright file="ElementwiseVectorCartesianSummationOperation2.cs" author="ameritusweb" date="5/2/2023">
...
namespace ParallelReverseAutoDiff.RMAD
{
    ...
    /// </summary>
    public class ElementwiseVectorCartesianSummationOperation2 : Operation
    {
        ...
        {
            return new ElementwiseVectorCartesianSummationOperation2();
        }
