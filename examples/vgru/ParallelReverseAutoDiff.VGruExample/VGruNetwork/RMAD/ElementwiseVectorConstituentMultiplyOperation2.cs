//------------------------------------------------------------------------------
// <copyright file="ElementwiseVectorConstituentMultiplyOperation2.cs" author="ameritusweb" date="5/2/2023">
...
namespace ParallelReverseAutoDiff.RMAD
{
    ...
    /// </summary>
    public class ElementwiseVectorConstituentMultiplyOperation2 : Operation
    {
        ...
        {
            return new ElementwiseVectorConstituentMultiplyOperation2();
        }
