// ------------------------------------------------------------------------------
// <copyright file="SpatialComputationGraph.cs" author="ameritusweb" date="12/18/2023">
...
namespace ParallelReverseAutoDiff.VGruExample.VGruNetwork
{
    ...
    /// </summary>
    public class SpatialComputationGraph : ComputationGraph
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SpatialComputationGraph"/> class.
        /// </summary>
        /// <param name="net">The neural network.</param>
        public SpatialComputationGraph(SpatialNetwork net)
            : base(net)
        {
        }
