// ------------------------------------------------------------------------------
// <copyright file="MazeComputationGraph.cs" author="ameritusweb" date="12/18/2023">
...
namespace ParallelReverseAutoDiff.VGruExample.VGruNetwork
{
    ...
    /// </summary>
    public class MazeComputationGraph : ComputationGraph
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MazeComputationGraph"/> class.
        /// </summary>
        /// <param name="net">The neural network.</param>
        public MazeComputationGraph(MazeNetwork net)
            : base(net)
        {
        }
