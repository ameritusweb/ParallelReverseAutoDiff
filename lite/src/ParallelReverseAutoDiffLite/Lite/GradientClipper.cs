...
namespace ParallelReverseAutoDiff.RMAD
{
    ...
    public class GradientClipper
    {
        ...
        private DeepMatrix ClipGradients(DeepMatrix gradients, float clipValue, float? minValue)
        {
            if (minValue == null)
            {
        ...
        private Matrix ClipGradients(Matrix gradients, float clipValue, float? minValue)
        {
            if (minValue == null)
            {
                minValue = this.network.Parameters.MinimumClipValue;
