...
namespace ParallelReverseAutoDiff.RMAD
{
    ...
    public class HierarchicalScalingOperation : Operation
    {
        ...
        {
            this.IntermediateMatrixArrays.AddOrUpdate(id, new[] { this.originalInput, this.input, this.rowScalars, this.colScalars, this.weightMatrix }, (x, y) => new[] { this.originalInput, this.input, this.rowScalars, this.colScalars, this.weightMatrix });
        }
        ...
        private float SafeExponential(float x)
        {
            if (x > PradMath.Log(float.MaxValue))
            {
