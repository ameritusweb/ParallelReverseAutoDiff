...
namespace ParallelReverseAutoDiff.PRAD
{
    ...
    public partial class PradOp
    {
        ...
        public class Ops
        {
            ...
            /// </summary>
            public static Func<float, AddGaussianNoiseOperation> AddGaussianNoiseOp => (d) => new AddGaussianNoiseOperation(d);
            ...
            /// </summary>
            public static Func<float, ApplyDropoutOperation> ApplyDropoutOp => (d) => new ApplyDropoutOperation(d);
            ...
            /// </summary>
            public static Func<float, DeepLeakyReLUOperation> DeepLeakyReLUOp => (d) => new DeepLeakyReLUOperation(d);
            ...
            /// </summary>
            public static Func<float, LeakyReLUOperation> LeakyReLUOp => (d) => new LeakyReLUOperation(d);
            ...
            /// Gets the SwigLU op.
            /// </summary>
            public static Func<float, SwigLUOperation> SwigLUOp => (d) => new SwigLUOperation(d);
