...
namespace ParallelReverseAutoDiff.RMAD
{
    ...
    public abstract class ComputationGraph
    {
        ...
        /// <returns>A computation graph.</returns>
        public ComputationGraph AddScalar(string identifier, Func<LayerInfo, float> scalar)
        {
        ...
        /// <param name="identifier">An identifier.</param>
        /// <param name="scalar">The scalar.</param>
        protected virtual void ScalarAdded(string identifier, Func<LayerInfo, float> scalar)
        {
