                ...
                for (int i = 0; i < pooledRows; i++)
                {
                    for (int j = 0; j < pooledCols; j++)
                    {
                        ...
                        for (int x = 0; x < this.poolSize; x++)
                        {
                            ...
                            {
                                float val = input[d, (i * this.poolSize) + x, (j * this.poolSize) + y];
                                if (val > maxVal)
                                {
                                    maxVal = val;
                                }
                ...
                for (int i = 0; i < pooledRows; i++)
                {
                    for (int j = 0; j < pooledCols; j++)
                    {
                        ...
                        for (int x = 0; x < this.poolSize; x++)
                        {
                            for (int y = 0; y < this.poolSize; y++)
                            {
                                float val = this.input[d, (i * this.poolSize) + x, (j * this.poolSize) + y];
                                if (val > maxVal)
                                {
                                    maxVal = val;
                                    maxIdxX = x;
                        ...
                        for (int x = 0; x < this.poolSize; x++)
                        {
                            for (int y = 0; y < this.poolSize; y++)
                            {
                                ...
                                {
                                    dInput[d, (i * this.poolSize) + x, (j * this.poolSize) + y] = 0.0f;
                                }
                            }
                        }
                    }
