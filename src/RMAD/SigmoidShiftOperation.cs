...
namespace ParallelReverseAutoDiff.RMAD
{
    ...
    public class SigmoidShiftOperation : Operation
    {
        ...
        public override BackwardResult Backward(Matrix dOutput)
        {
            ...
            double dSigmoidMin = this.sigmoidMin * (1 - this.sigmoidMin); // Derivative of sigmoid
        ...
        private (double minValue, (int row, int col) position) FindMinimumWithValueAndPosition(Matrix matrix)
        {
