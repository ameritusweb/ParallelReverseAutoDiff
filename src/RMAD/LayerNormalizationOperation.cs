...
namespace ParallelReverseAutoDiff.RMAD
{
    ...
    public class LayerNormalizationOperation : Operation
    {
        ...
        {
            this.IntermediateObjectArrays.AddOrUpdate(id, new[] { (object)this.input, (object)this.mean, (object)this.stdDev, (object)this.numRows, (object)this.numCols }, (_, _) => new[] { (object)this.input, (object)this.mean, (object)this.stdDev, (object)this.numRows, (object)this.numCols });
        }
