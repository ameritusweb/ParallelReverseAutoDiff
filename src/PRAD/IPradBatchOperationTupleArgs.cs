//------------------------------------------------------------------------------
// <copyright file="IPradBatchOperationTupleArgs.cs" author="ameritusweb" date="6/20/2024">
...
namespace ParallelReverseAutoDiff.PRAD
{
    ...
    public interface IPradBatchOperationTupleArgs<TOperation, TTuple> : IPradBatchOperationArgs<TOperation>
    ...
    public interface IPradBatchOperationArgs<TOperation>
        where TOperation : IBatchOperation
    {
    }
}
