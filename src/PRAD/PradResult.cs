...
namespace ParallelReverseAutoDiff.PRAD
{
    ...
    public class PradResult : PradResultBase
    {
        ...
        /// <param name="other">The other tensor.</param>
        /// <param name="additional">The additional tensor.</param>
        /// <param name="sparsity">The sparsity tensor.</param>
        /// <returns>A PradResult.</returns>
        public PradResult Then(Func<Tensor, Tensor, Tensor, PradResult> operation, Tensor other, Tensor additional, Tensor sparsity)
        {
            var instanceOperation = this.PradOp.GetOperation<Func<Tensor, Tensor, Tensor, PradResult>>(operation);
            return instanceOperation(other, additional, sparsity);
        }
