//------------------------------------------------------------------------------
// <copyright file="PradDeepOperationBase.cs" author="ameritusweb" date="6/20/2024">
...
namespace ParallelReverseAutoDiff.PRAD
{
    ...
    public abstract class PradDeepOperationBase<TOperation, TSubType, TReturnType> : OperationBase, IDeepOperation
        where TOperation : PradDeepOperationBase<TOperation, TSubType, TReturnType>
    {
        /// <summary>
